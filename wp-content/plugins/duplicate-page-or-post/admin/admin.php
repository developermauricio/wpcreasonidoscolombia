	...
	color: #7052fb;
		...
		<div class="featured_plugin_main">
			...
			<div class="featured_plugin_information">
				<div class="featured_plugin_title"><h4><a target="_blank" href="<?php echo esc_url($plugin['site_url']) ?>"><?php echo esc_attr($plugin['title']); ?></a></h4></div>
				<p class="featured_plugin_description"><?php echo $plugin['description'] ?></p>
				<a target="_blank" href="<?php echo esc_url($plugin['site_url']); ?>" class="blue_button"><?php echo __( 'Check The Plugin', 'wpda_duplicate' ); ?></a>
			</div>
